...
## Quick installation
- Download [yimutils.lua](https://github.com/pierrelasse/YimStuff/releases/download/stable/yimutils.lua) and optionally [SussySpt.lua](https://github.com/pierrelasse/YimStuff/releases/download/stable/SussySpt.lua) too and put them into your scripts folder `%appdata%/YimMenu/scripts`
