...
values.g = {
    ...
    apartment_jobs_1 = fm + 9237, -- "ROOT_ID_HASH_THE_FLECCA_JOB"
    apartment_jobs_2 = fm + 9242, -- "ROOT_ID_HASH_THE_PRISON_BREAK"
    apartment_jobs_3 = fm + 9249, -- "ROOT_ID_HASH_THE_HUMANE_LABS_RAID"
    apartment_jobs_4 = fm + 9255, -- "ROOT_ID_HASH_SERIES_A_FUNDING"
    apartment_jobs_5 = fm + 9261  -- "ROOT_ID_HASH_THE_PACIFIC_STANDARD_JOB"
}
